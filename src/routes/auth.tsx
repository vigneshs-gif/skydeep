...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      { title: "Sign in — SkyDeep Airlines" },
      { name: "description", content: "Sign in or create your SkyDeep Airlines account." },
    ],
  }),
  component: AuthPage,
});
    ...
    <div className="min-h-[calc(100vh-4rem)] grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex bg-hero-gradient text-white p-12 flex-col justify-between relative overflow-hidden">
        ...
        <Link to="/" className="relative flex items-center gap-2">
          ...
          <span className="font-display text-lg font-bold">SkyDeep Airlines</span>
        </Link>
        <div className="relative">
          ...
          <p className="mt-4 text-white/70 max-w-md">
            Realtime seat availability, flight status pushed straight to your dashboard, instant e-tickets.
          </p>
        </div>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Start booking in seconds.</p>
      </div>
      <div className="space-y-2">
